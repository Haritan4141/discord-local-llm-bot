...
- Separate worktree `discord-local-llm-bot-yue2-pr`, branch `codex/yue2-bot-integration`, base `a0a6c6a`.
...
- [ ] Document acceptance, review parallel-PR overlaps, commit/push and open PR (no merge).
